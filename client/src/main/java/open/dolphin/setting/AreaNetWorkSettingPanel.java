...
public class AreaNetWorkSettingPanel extends AbstractSettingPanel {
    ...
    private static final String ICON = "icon_area_network_settings_small";
    ...
    class StateMgr {
        ...
        private boolean isValid() {
            if (joinAreaNetwork.isSelected()) {
                ...
                boolean facilityOk = !facilityIdField.getText().trim().isEmpty();
                boolean creatorOk = !creatorIdField.getText().trim().isEmpty();
