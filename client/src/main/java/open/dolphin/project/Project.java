...
public class Project  {
    ...
    // ORCA API
    public static final String USE_ORCA_API             = "useOrcaApi";
    public static final String ORCA_USER_ID             = "orcaUserId";
    public static final String ORCA_USER_PASSWORD       = "orcaUserPassword";
    ...
    public static boolean isReadOnly() {
        ...
        return !LICENSE_DOCTOR.equals(licenseCode);
    }
