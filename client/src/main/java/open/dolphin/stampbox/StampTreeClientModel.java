 ...
 * renamed by masuda from StampTreeModel to distinguish from open.dolphin.infomodel.StampTreeModel
 */
public class StampTreeClientModel extends DefaultTreeModel {

    /**
     * デフォルトコンストラクタ
     */
    public StampTreeClientModel(TreeNode node) {
        super(node);
    }
